...
>(({ className, ...props }, ref) => (
  <input
    ...
    data-sidebar="input"
    className={cn(
      "flex h-8 w-full bg-transparent px-3 py-1 text-sm outline-none placeholder:text-sidebar-foreground/50 disabled:cursor-not-allowed disabled:opacity-50",
      className,
    )}
    {...props}
  />
...
const SidebarMenuButton = React.forwardRef<
  HTMLButtonElement,
  React.ButtonHTMLAttributes<HTMLButtonElement> & { isActive?: boolean; asChild?: boolean; tooltip?: string }
>(({ isActive, className, asChild = false, ...props }, ref) => {
